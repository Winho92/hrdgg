...
.champDetail_nav .champDetail_list ul {
	display: block;
	width: 100%;
    margin: 0 auto;
    padding: 0;
...
.champDetail_nav .champDetail_list li {
	display: inline-block;
}

.champDetail_nav .champDetail_list .Item.active {
	border-color: #000;
}

.champDetail_nav .champDetail_list .Item {
	display: inline-block;
    margin: 0 30px -1px 0;
    padding: 0;
...
.champDetail_nav .champDetail_list .menus {
	display: block;
    color: #555e5e;
    font-size: 18px;
    line-height: 15px;
...
#champInfo .champIcon {
	...
	height: 120px;
	overflow: hidden;
	background: url(/img/bg_img/bg_86x86_champion_image.png) no-repeat left
		top;
	background-size: 100%;
}
...
#champSkin .prev:hover, #champSkin .next:hover {
...
#champSkin .slideshow-container .text span {
...
#champSkin .active, #champSkin .dot:hover {
...
<script>
	$(function() {
		...
		$('.menus').on('click', function() {
			...
			$('.champDetail_list').children().children().each(function(idx, item){
				$(item).attr('class', 'Item');
			});
			switch($(this).attr('id')) {
			case 'menu0':
				$('#champInfo').fadeIn(1000);
				$('#menu0').parent().attr('class', 'Item active');
				break;
			case 'menu1':
				$('#champStat').fadeIn(1000);
				$('#menu1').parent().attr('class', 'Item active');
				break;
			case 'menu2':
				$('#champSkill').fadeIn(1000);
				$('#menu2').parent().attr('class', 'Item active');
				break;
			case 'menu3':
				$('#champSkin').fadeIn(1000);
				$('#menu3').parent().attr('class', 'Item active');
				break;
			}
		});
	...
	<div id="home">
		...
		<div class="champDetail_main">
			<div class="champDetail_nav">
				<div class="champDetail_list">
					<ul>
						<li class="Item active">
							<a href="javascript:void(0);" id="menu0" class="menus">챔피언 정보</a>
						</li>
						<li class="Item"><a href="javascript:void(0);" id="menu1" class="menus">능력치</a></li>
						<li class="Item"><a href="javascript:void(0);" id="menu2" class="menus">스킬</a></li>
						<li class="Item"><a href="javascript:void(0);" id="menu3" class="menus">스킨</a></li>
						<li class="Item"><a href="/champion" id="menu4" class="menus">챔피언 목록</a></li>
					</ul>
				</div>
			</div>
			<div id="champView">
				<!-- 챔피언정보 -->
				<div id="champInfo"
					style="background-image: url(/img/splash/${champVo.id}_0.jpg);">
					<div class="shadow">
						<div class="champ_img">
							<div class="champIcon">
						...
						<div class="etcPart">
							...
							<c:forEach items="${fn:split(champVo.tags,'|') }" var="item"
								varStatus="g">
						    ${item}
						    <c:if test="${!g.last}">
						    	, 
							...
							<div style="display: block; position: relative;">
								<div class="div2">
									<div class="skillIcon">
										<c:choose>
											<c:when
												test="${fn:length(fn:split(champVo.spellQ,'|')) gt 4}">
												<img alt="${fn:split(champVo.spellQ,'|')[5]}"
													src="/img/${fn:split(champVo.spellQ,'|')[5]}">
											</c:when>
											<c:otherwise>
							...
							<div style="display: block; position: relative;">
								<div class="div2">
									<div class="skillIcon">
										<c:choose>
											<c:when
												test="${fn:length(fn:split(champVo.spellW,'|')) gt 4}">
												<img alt="${fn:split(champVo.spellW,'|')[5]}"
													src="/img/${fn:split(champVo.spellW,'|')[5]}">
											</c:when>
											<c:otherwise>
							...
							<div style="display: block; position: relative;">
								<div class="div2" style="vertical-align: middle;">
									<div class="skillIcon">
										<c:choose>
											<c:when
												test="${fn:length(fn:split(champVo.spellE,'|')) gt 4}">
												<img alt="${fn:split(champVo.spellE,'|')[5]}"
													src="/img/${fn:split(champVo.spellE,'|')[5]}">
											</c:when>
											<c:otherwise>
							...
							<div style="display: block; position: relative;">
								<div class="div2">
									<div class="skillIcon">
										<c:choose>
											<c:when
												test="${fn:length(fn:split(champVo.spellR,'|')) gt 4}">
												<img alt="${fn:split(champVo.spellR,'|')[5]}"
													src="/img/${fn:split(champVo.spellR,'|')[5]}">
											</c:when>
											<c:otherwise>
					...
					<div class="slideshow-container">
						...
						<c:forEach var="skin" items="${fn:split(champVo.skins,'|')}"
							...
							<div class="mySlides fade">
								...
								<img
									src="/img/splash/${champVo.id}_${fn:split(skin,',')[0]}.jpg"
									style="width: 100%">
